...
export default function Orb({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      // Prevent rendering at zero size
    ...
    const update = (t) => {
      if (!isActive || !rendererRef.current || !programRef.current || !meshRef.current) return;
      ...
      programRef.current.uniforms.hover.value += (effectiveHover - programRef.current.uniforms.hover.value) * 0.1;
    ...
    return () => {
      ...
      // Only destroy renderer on full component unmount
      if (!ctnDom.current && rendererRef.current) {
