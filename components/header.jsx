    ...
    <>
      <motion.header 
        className={`fixed top-0 z-30 w-full transition-all duration-300 ${
          scrolled ? 'bg-gray-900/90 backdrop-blur-md py-3 shadow-lg' : 'bg-gray-900/60 backdrop-blur-sm py-5'
        }`}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
          ...
          <Link href="/home">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="font-bold text-xl tracking-tight bg-gradient-to-r from-indigo-400 via-purple-300 to-amber-300 bg-clip-text text-transparent">
                  Map of Wonders
                </span>
